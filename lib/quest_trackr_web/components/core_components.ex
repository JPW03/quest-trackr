defmodule QuestTrackrWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 dark:shadow-zinc-300/10 ring-zinc-700/10 dark:ring-zinc-300/10 relative hidden rounded-2xl bg-white dark:bg-black p-14 shadow-lg ring-1 transition"
            >
  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :info && "bg-emerald-50 text-emerald-800 ring-emerald-500 fill-cyan-900 dark:bg-emerald-950 dark:text-emerald-200 dark:fill-cyan-100",
        @kind == :error && "bg-rose-50 text-rose-900 shadow-md ring-rose-500 fill-rose-900 dark:bg-rose-950 dark:text-rose-200 dark:fill-rose-100"
      ]}
      {@rest}
    >
  ...
  def button(assigns) do
    ...
    <button
      ...
      class={[
        ...
        "text-sm font-semibold leading-6 text-white dark:text-black active:text-white/80 dark:active:text-black/80",
        @class
      ]}
      {@rest}
    >
    ...
    <div class="overflow-y-auto px-4 sm:overflow-visible sm:px-0">
      <table class="w-[40rem] mt-11 sm:w-full">
        ...
        <tbody
          ...
          class="relative divide-y divide-zinc-100 dark:divide-zinc-900 border-t border-zinc-200 dark:border-zinc-800 text-sm leading-6 text-zinc-700 dark:text-zinc-300"
        >
  ...
  @doc """
  Renders a dark/light mode toggle.
  """
  def theme_toggle(assigns) do
    ~H"""
    <label for="theme-toggle" class="cursor-pointer flex items-center relative rounded-full">
      <button onclick="themeToggle()" id="theme-toggle" class="hidden" />
      <div class="w-14 h-7 rounded-full
            bg-zinc-100 hover:bg-zinc-200/80
            dark:bg-zinc-900 hover:dark:bg-zinc-800/80" />
      <span class="absolute w-7 h-7 rounded-full shadow-md
                  bg-zinc-700 dark:bg-zinc-300
                  hero-sun-solid dark:hero-moon-solid
                  dark:translate-x-7 transition-all" />
    </label>
    <script>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(QuestTrackrWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(QuestTrackrWeb.Gettext, "errors", msg, opts)
    end
  end
