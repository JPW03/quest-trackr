defmodule QuestTrackrWeb.UserSettingsLive do
    ...
    <div class="space-y-12 divide-y">
      <div>
        <.simple_form
          ...
          phx-trigger-action={@username_trigger_submit}
        >
      ...
      <div>
        <.simple_form
          ...
          phx-trigger-action={@password_trigger_submit}
        >
          <.input
  ...
  def handle_event("update_password", params, socket) do
    ...
    case Accounts.update_user_password(user, password, user_params) do
      {:ok, user} ->
        ...
        {:noreply, assign(socket, password_trigger_submit: true, password_form: password_form)}
  ...
  def handle_event("update_username", params, socket) do
    ...
    case Accounts.update_user_username(user, password, user_params) do
      {:ok, applied_user} ->
        ...
        {:noreply, assign(socket, username_trigger_submit: true, username_form: username_form)}
